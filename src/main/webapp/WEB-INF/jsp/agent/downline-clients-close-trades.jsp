...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
    													<div id="downline-clients-trades-table-config" class="modal hide" style="width:400px;">
    													...
    													<div class="clearfix">
															<div class="btn-group pull-right">
																<div id="downline-clients-date-range" class="btn pull-right datepickerrange">
																	<i class="icon-calendar"></i> &nbsp;<span></span> <b
																		class="caret"></b>
																</div>
															</div>
															<div class="pull-right">
    															<a href="#downline-clients-trades-table-config" data-toggle="modal" class="btn green icn-only"><i class="icon-user icon-cog"></i></a>
    														</div>
														</div>
														<table id="downline-clients-trades-table" class="table table-striped table-bordered table-advance table-hover">
															<thead>
																<tr>
