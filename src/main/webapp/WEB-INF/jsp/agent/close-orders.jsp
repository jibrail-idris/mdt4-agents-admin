...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
    													...
    													<div class="clearfix">    														
															...
															<div class="pull-right">
    															<a href="#clients-close-trades-table-config" data-toggle="modal" class="btn green icn-only"><i class="icon-user icon-cog"></i></a>
    														</div>
														</div>
														<table id="clients-close-trades-table" class="table table-striped table-bordered table-advance table-hover hide">
															<thead>
																<tr>
																	...
																	<th><spring:message code="label.commission"/></th>
																</tr>
															</thead>
															<tbody>
