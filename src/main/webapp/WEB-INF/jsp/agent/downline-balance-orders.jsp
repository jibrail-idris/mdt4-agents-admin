...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
    													<div id="clients-downlines-balance-table-config" class="modal hide" style="width:400px;">
    													...
    													<div class="clearfix">    														
															<div class="btn-group pull-right">
																<div id="clients-downlines-balance-date-range" class="btn pull-right datepickerrange">
																	<i class="icon-calendar"></i> &nbsp;<span></span> <b
																		class="caret"></b>
																</div>
															</div>
															<div class="pull-right">
    															<a href="#clients-downlines-balance-table-config" data-toggle="modal" class="btn green icn-only"><i class="icon-user icon-cog"></i></a>
    														</div>
														</div>
														<table id="clients-downlines-balance-table" class="table table-striped table-bordered table-advance table-hover hide">
															<thead>
																<tr>
																	<th><spring:message code="label.downline"/></th>
